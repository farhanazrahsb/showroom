                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form action="parts_tambah_input.php" method="post" enctype="multipart/form-data" role="form">
                                    ...
                                    <label>Velg/Alloy Wheels</label>
                                        <input class="form-control" type="text" name="velg" placeholder="Velg/Alloy Wheels" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Sistem Kemudi/Steering</label>
                                        <input class="form-control" type="text" name="steering" placeholder="Sistem Kemudi/Steering" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Ukuran Ban Depan Dan Belakang</label>
                                        <input class="form-control" type="text" name="ukuran_ban" placeholder="Ukuran Ban Depan Dan Belakang" autocomplete="Off">
                                    </div>
                                    </div>
                                    <div class="col-lg-6">
                                    <h2>Rem</h2>   
                                    ...
                                    <label>Rem Depan</label>
                                        <input class="form-control" type="text" name="rem_depan" placeholder="Rem Depan" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Rem Belakang</label>
                                        <input class="form-control" type="text" name="rem_belakang" placeholder="Rem Belakang" autocomplete="Off">
                                    </div>
                                    <h2>Suspension</h2>                   
                                    <div class="form-group">
                                    <label>Suspensi Depan</label>
                                        <input class="form-control" type="text" name="suspensi_depan" placeholder="Suspensi Depan" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Suspensi Belakang</label>
                                        <input class="form-control" type="text" name="suspensi_belakang" placeholder="Suspensi Belakang" autocomplete="Off">
                                    </div>
                                    <h2>Warna</h2>   
                                    <div class="form-group">
                                    <label>Warna</label>
                                        <input class="form-control" type="text" name="warna" placeholder="Warna" autocomplete="Off">
                                    </div>
