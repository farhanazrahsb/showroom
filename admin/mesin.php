                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="mesin_tambah.php"><button class="btn btn-success"><i class="fa fa-plus"></i></button></a>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    ...
                                    <th>Nama Mobil</th>
                                    <th>Type Mobil</th>
                                    <th>Diameter x Langkah(mm)</th>
                                    <th>Perbandingan Kompresi</th>
                                    <th>Jumlah/Tipe Silinder</th>
                                    <th>Kapasitas Silinder(CC)</th>
                                    <th>Sistme Bahan Bakar</th>
                                    <th>Bahan Bakar</th>
                                    <th>Daya Maksimum</th>
                                    <th>Torsi Minimum</th>
                                    <th>Tipe Mesin</th>
                                    <th>Sistem Penggerak Roda</th>
                                ...
                                include "../koneksi/koneksi.php";
                                $no = 1;
                                $query = mysqli_query($koneksi, "SELECT * FROM mesin ORDER BY id_type ASC");
                                while ($var=mysqli_fetch_array($query)) {
                                ...
                                ?>
                                    ...
                                    <td align="center">
                                    <a href="mesin_edit.php?&no=<?php echo $var['no']; ?>"><button class="btn btn-warning" title="Detail"><i class="fa fa-edit"></i></button></a>
                                    </td>
                                    <td align="center">
                                    <a href="#" onclick="confirm_modal('mesin_delete.php?&no=<?php echo $var['no']; ?>');"><button class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i></button></a>
                                    </td>
                                    </tr>
                                <?php
                                }
