                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="keamanan_tambah.php"><button class="btn btn-success"><i class="fa fa-plus"></i></button></a>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    ...
                                    <th>Type Mobil</th>
                                    <th>Alarm</th>
                                    <th>Anti Lock Breaking System(ABS)</th>
                                    <th>Kunci Sentral/Central Lock</th>
                                    <th>Child Lock</th>
                                    <th>Bantal Udara/Airbag Pengemudi</th>
                                    <th>Bantal Udara/Airbag Depan</th>
                                    <th>Bantal Udara/Airbag Samping</th>
                                    <th>Electronic Stability Program(ESP)</th>
                                    <th>Euro NCAP Occupant Protection</th>
                                    <th>Euro NCAP Child Protection</th>
                                    <th>Euro NCAP Pedestrian Protection</th>
                                    <th>Euro NCAP Overall Rating</th>
                                    <th>Sabuk Pengaman Depan</th>
                                    <th>Sabuk Pengaman Belakang</th>
                                    <th>Sabuk Pengaman Pretensioner</th>
                                    <th>Immobiliser</th>
                                    <th>Sensor Hujan</th>
                                    <th>Sensor Parkir</th>
                                    <th>Kaca Spion Belakang/Rear Reflector</th>
                                ...
                                include "../koneksi/koneksi.php";
                                $no = 1;
                                $query = mysqli_query($koneksi, "SELECT * FROM keamanan ORDER BY id_type ASC");
                                while ($var=mysqli_fetch_array($query)) {
                                ...
                                ?>
                                    ...
                                    <td align="center">
                                    <a href="keamanan_edit.php?&no=<?php echo $var['no']; ?>"><button class="btn btn-warning" title="Detail"><i class="fa fa-edit"></i></button></a>
                                    </td>
                                    <td align="center">
                                    <a href="#" onclick="confirm_modal('keamanan_delete.php?&no=<?php echo $var['no']; ?>');"><button class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i></button></a>
                                    </td>
                                    </tr>
                                <?php
                                }
