    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Tambah Partner Insurance</h2>   
                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form action="insurance_tambah_input.php" method="post" enctype="multipart/form-data" role="form">
                                    ...
                                    <label>Nama Marketing</label>
                                        <input class="form-control" type="text" name="nama_market" placeholder="Nama Marketing" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Nomor Handphone</label>
                                        <input class="form-control" type="text" name="no_hp" placeholder="Nomor Handphone" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Alamat</label>
                                    ...
                                    <div class="form-group">
                                    <label>Kota</label>
                                        <input class="form-control" type="text" name="kota" placeholder="Kota" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Map</label>
                                        <textarea class="form-control" name="map" placeholder="Map"></textarea>
                                    </div>
                                    <div class="form-group">
                                    <label>Gambar</label>
