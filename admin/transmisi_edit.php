                ...
                <ul class="nav" id="main-menu">
                    ...
                    <a href="#" class="active-menu"><i class="fa fa-car fa-fw"></i> Showroom<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                            <a href="transmisi.php" class="active-menu"><i class="fa fa-plus fa-fw"></i> Transmisi</a>
                            </li>
                            <li>
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        include "../koneksi/koneksi.php";
                        $no = $_GET['no'];
                        $query = mysqli_query($koneksi, "SELECT * FROM transmisi WHERE no = '$no'");
                        while($var=mysqli_fetch_array($query)){
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <form action="transmisi_edit_query.php" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 1st</label>
                                        <input class="form-control" type="text" name="gigi1" value="<?php echo $var['gigi1']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 2nd</label>
                                        <input class="form-control" type="text" name="gigi2" value="<?php echo $var['gigi2']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 3rd</label>
                                        <input class="form-control" type="text" name="gigi3" value="<?php echo $var['gigi3']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 4th</label>
                                        <input class="form-control" type="text" name="gigi4" value="<?php echo $var['gigi4']; ?>" autocomplete="Off">
                                    </div>
                                    </div>
                                    <div class="col-lg-6">
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 5th</label>
                                        <input class="form-control" type="text" name="gigi5" value="<?php echo $var['gigi5']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 6th</label>
                                        <input class="form-control" type="text" name="gigi6" value="<?php echo $var['gigi6']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 7th</label>
                                        <input class="form-control" type="text" name="gigi7" value="<?php echo $var['gigi7']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 8th</label>
                                        <input class="form-control" type="text" name="gigi8" value="<?php echo $var['gigi8']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi Reverse</label>
                                        <input class="form-control" type="text" name="gigi_reverse" value="<?php echo $var['gigi_reverse']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi Akhir</label>
                                        <input class="form-control" type="text" name="gigi_akhir" value="<?php echo $var['gigi_akhir']; ?>" autocomplete="Off">
                                    </div>
                                    <input type="submit" class="btn btn-success" value="Update">
                                    <a href="transmisi.php" class="btn btn-warning">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
