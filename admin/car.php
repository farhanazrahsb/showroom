                ...
                <ul class="nav" id="main-menu">
                    ...
                    <a href="#" class="active-menu"><i class="fa fa-car fa-fw"></i> Showroom<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                            <a href="car.php" class="active-menu"><i class="fa fa-plus fa-fw"></i> Cars</a>
                            </li>
                            <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="car_tambah.php"><button class="btn btn-success"><i class="fa fa-plus"></i></button></a>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                include "../koneksi/koneksi.php";
                                $no = 1;
                                $query = mysqli_query($koneksi, "SELECT * FROM showroom ORDER BY id_mobil ASC");
                                while ($var=mysqli_fetch_array($query)) {
                                     
                                ?>
                                    <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $var['id_mobil']; ?></td>
                                    <td><?php echo $var['nama']; ?></td>
                                    <td><?php echo $var['jenis']; ?></td>
                                    <td><?php echo $var['cc']; ?></td>
                                    <td><?php echo $var['bbm']; ?></td>
                                    <td><?php echo $var['penumpang']; ?></td>
                                    <td><?php echo $var['harga']; ?></td>
                                    <td><div class="readmore"><?php echo $var['tentang']; ?></div></td>
                                    <td><img src="images/showroom/<?php echo $var['gambar'];?>" width="50" height="50"><br>
                                    <?php echo $var['gambar']; ?></td>
                                    <td align="center">
                                    <a href="car_edit.php?&no=<?php echo $var['no']; ?>"><button class="btn btn-warning" title="Detail"><i class="fa fa-edit"></i></button></a>
                                    </td>
                                    <td align="center">
                                    <a href="#" onclick="confirm_modal('car_delete.php?&no=<?php echo $var['no']; ?>');"><button class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i></button></a>
                                    </td>
                                    </tr>
                                <?php
                                }
