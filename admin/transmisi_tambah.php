                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form action="transmisi_tambah_input.php" method="post" enctype="multipart/form-data" role="form">
                                    ...
                                    <label>Perbandingan Gigi 1st</label>
                                        <input class="form-control" type="text" name="gigi1" placeholder="Perbandingan Gigi 1st" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 2nd</label>
                                        <input class="form-control" type="text" name="gigi2" placeholder="Perbandingan Gigi 2nd" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 3rd</label>
                                        <input class="form-control" type="text" name="gigi3" placeholder="Perbandingan Gigi 3rd" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 4th</label>
                                        <input class="form-control" type="text" name="gigi4" placeholder="Perbandingan Gigi 4th" autocomplete="Off">
                                    </div>
                                    </div>
                                    <div class="col-lg-6">
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 5th</label>
                                        <input class="form-control" type="text" name="gigi5" placeholder="Perbandingan Gigi 5th" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 6th</label>
                                        <input class="form-control" type="text" name="gigi6" placeholder="Perbandingan Gigi 6th" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 7th</label>
                                        <input class="form-control" type="text" name="gigi7" placeholder="Perbandingan Gigi 7th" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi 8th</label>
                                        <input class="form-control" type="text" name="gigi8" placeholder="Perbandingan Gigi 8th" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi Reverse</label>
                                        <input class="form-control" type="text" name="gigi_reverse" placeholder="Perbandingan Gigi Reverse" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Gigi Akhir</label>
                                        <input class="form-control" type="text" name="gigi_akhir" placeholder="Perbandingan Gigi Akhir" autocomplete="Off">
                                    </div>
