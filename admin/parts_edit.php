                ...
                <ul class="nav" id="main-menu">
                    ...
                    <a href="#" class="active-menu"><i class="fa fa-car fa-fw"></i> Showroom<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                            <a href="parts.php" class="active-menu"><i class="fa fa-plus fa-fw"></i> Parts</a>
                            </li>
                        </ul>
                    </li>
                    <li>
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        include "../koneksi/koneksi.php";
                        $no = $_GET['no'];
                        $query = mysqli_query($koneksi, "SELECT * FROM parts WHERE no = '$no'");
                        while($var=mysqli_fetch_array($query)){
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <form action="parts_edit_query.php" enctype="multipart/form-data" method="post">
                                    <input type="hidden" name="no" class="form-control" value="<?php echo $var['no']; ?>">
                                    <h2>Sasis, Ban Dan Velg</h2> 
                                    ...
                                    <div class="form-group">
                                    <label>Velg/Alloy Wheels</label>
                                        <input class="form-control" type="text" name="velg" value="<?php echo $var['velg']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Sistem Kemudi/Steering</label>
                                        <input class="form-control" type="text" name="steering" value="<?php echo $var['steering']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Ukuran Ban Depan Dan Belakang</label>
                                        <input class="form-control" type="text" name="ukuran_ban" value="<?php echo $var['ukuran_ban']; ?>" autocomplete="Off">
                                    </div>
                                    </div>
                                    <div class="col-lg-6">
                                    <h2>Rem</h2>   
                                    ...
                                    <label>Rem Depan</label>
                                        <input class="form-control" type="text" name="rem_depan" value="<?php echo $var['rem_depan']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Rem Belakang</label>
                                        <input class="form-control" type="text" name="rem_belakang" value="<?php echo $var['rem_belakang']; ?>" autocomplete="Off">
                                    </div>
                                    <h2>Suspension</h2>                   
                                    <div class="form-group">
                                    <label>Suspensi Depan</label>
                                        <input class="form-control" type="text" name="suspensi_depan" value="<?php echo $var['suspensi_depan']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Suspensi Belakang</label>
                                        <input class="form-control" type="text" name="suspensi_belakang" value="<?php echo $var['suspensi_belakang']; ?>" autocomplete="Off">
                                    </div>
                                    <h2>Warna</h2>   
                                    <div class="form-group">
                                    <label>Warna</label>
                                        <input class="form-control" type="text" name="warna" value="<?php echo $var['warna']; ?>" autocomplete="Off">
                                    </div>
                                    <input type="submit" class="btn btn-success" value="Update">
                                    <a href="parts.php" class="btn btn-warning">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
