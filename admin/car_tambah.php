                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form action="car_tambah_input.php" method="post" enctype="multipart/form-data" role="form">
                                    <div class="form-group">
                                    <label>ID Mobil</label>
                                    <?php 
                                    include "../koneksi/koneksi.php";
                                    $carikode = mysqli_query($koneksi, "select max(id_mobil) from showroom") or die (mysqli_error());
                                    ...
                                    echo'
                                        <input class="form-control" type="text" name="id_mobil" value="'.$kode_otomatis.'" readonly>
                                    ';?>
                                    </div>
                                    <label>Nama Mobil</label>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Toyota</span>
                                        <input class="form-control" type="text" name="nama" placeholder="Nama Mobil" autocomplete="Off">
                                    </div>
