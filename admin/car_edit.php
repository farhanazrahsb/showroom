            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        include "../koneksi/koneksi.php";
                        $no = $_GET['no'];
                        $query = mysqli_query($koneksi, "SELECT * FROM showroom WHERE no = '$no'");
                        while($var=mysqli_fetch_array($query)){
                        ?>
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <form action="car_edit_query.php" enctype="multipart/form-data" method="post">
                                    <input type="hidden" name="no" class="form-control" value="<?php echo $var['no']; ?>">
                                    <div class="form-group">
                                    <label>ID Mobil</label>
                                    <input type="text" name="id_mobil" class="form-control" value="<?php echo $var['id_mobil']; ?>" readonly>
                                    </div>
                                    <label>Nama Mobil</label>
                                    <div class="form-group input-group">
                                    <span class="input-group-addon">Toyota</span>
                                    <input type="text" name="nama" class="form-control" value="<?php echo $var['nama']; ?>" autocomplete="Off">                                
                                    </div>
                                    <h6 style="color: red;">* Nama Mobil Tidak Boleh Duplicate</h6>
                                    <div class="form-group">
                                    <label>Jenis</label>
                                    ...
                                    <textarea name="tentang" class="form-control" value="<?php echo $var['tentang']; ?>"><?php echo $var['tentang']; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                    <label>Gambar</label>
                                    ...
                                    <div class="form-group">
                                    <span><center><img src="images/showroom/<?php echo $var['gambar']; ?>" width="100" height="100"></center></span>
                                    <span><center><?php echo $var['gambar']; ?></center></span>
                                    </div>
                                    </div>
                                    <input type="submit" class="btn btn-success" value="Update">
                                    <a href="car.php" class="btn btn-warning">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
