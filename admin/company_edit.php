        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                    <a href="company.php" class="active-menu"><i class="fa fa-building fa-fw"></i> Company Profile</a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        include "../koneksi/koneksi.php";
                        $no = $_GET['no'];
                        $query = mysqli_query($koneksi, "SELECT * FROM profile WHERE no = '$no'");
                        while($var=mysqli_fetch_array($query)){
                        ?>
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <form action="company_edit_query.php" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" name="email" class="form-control" value="<?php echo $var['email']; ?>" autocomplete="Off">
                                    </div>
						            <div class="form-group">
						            <label>Alamat</label>
                                    ...
                                    <a href="company.php" class="btn btn-warning">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
