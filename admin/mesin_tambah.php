                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form action="mesin_tambah_input.php" method="post" enctype="multipart/form-data" role="form">
                                    ...
                                    <label>Diameter x Langkah(mm)</label>
                                        <input class="form-control" type="text" name="diameter" placeholder="Diameter x Langkah(mm)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Kompresi</label>
                                        <input class="form-control" type="text" name="kompresi" placeholder="Perbandingan Kompresi" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Jumlah/Tipe Silinder</label>
                                        <input class="form-control" type="text" name="jumlah_silinder" placeholder="Jumlah/Tipe Silinder" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Kapasitas Silinder(CC)</label>
                                        <input class="form-control" type="text" name="kapasitas_silinder" placeholder="Kapasitas Silinder(CC)" autocomplete="Off">
                                    </div>
                                    </div>
                                    <div class="col-lg-6">
                                    <div class="form-group">
                                    <label>Sistem Bahan Bakar</label>
                                        <input class="form-control" type="text" name="sistem_bbm" placeholder="Sistem Bahan Bakar" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <label>Daya Maksimum</label>
                                        <input class="form-control" type="text" name="daya_maks" placeholder="Daya Maksimum" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Torsi Maksimum</label>
                                        <input class="form-control" type="text" name="torsi_maks" placeholder="Torsi Maksimum" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Tipe Mesin</label>
                                        <input class="form-control" type="text" name="tipe_mesin" placeholder="Tipe Mesin" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Sistem Penggerak Roda</label>
                                        <input class="form-control" type="text" name="penggerak_roda" placeholder="Sistem Penggerak Roda" autocomplete="Off">
                                    </div>
