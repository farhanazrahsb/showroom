            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        include "../koneksi/koneksi.php";
                        $no = $_GET['no'];
                        $query = mysqli_query($koneksi, "SELECT * FROM dimensi WHERE no = '$no'");
                        while($var=mysqli_fetch_array($query)){
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <form action="dimensi_edit_query.php" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                    <label>Berat Kosong Tanpa Muatan(Kg)</label>
                                        <input class="form-control" type="text" name="berat_tanpa_muatan" value="<?php echo $var['berat_tanpa_muatan']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Berat Kosong Dengan Muatan(Kg)</label>
                                        <input class="form-control" type="text" name="berat_muatan" value="<?php echo $var['berat_muatan']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Jarak Pijak Depan(mm)</label>
                                        <input class="form-control" type="text" name="jarak_depan" value="<?php echo $var['jarak_depan']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Jarak Rendah Kendaraan(mm)</label>
                                        <input class="form-control" type="text" name="jarak_rendah" value="<?php echo $var['jarak_rendah']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Jarak Pijak Belakang(mm)</label>
                                        <input class="form-control" type="text" name="jarak_belakang" value="<?php echo $var['jarak_belakang']; ?>" autocomplete="Off">
                                    </div>
                                    </div>
                                    <div class="col-lg-6">
                                    <div class="form-group">
                                    <label>Kapasitas Tangki(L)</label>
                                        <input class="form-control" type="text" name="kapasitas_tangki" value="<?php echo $var['kapasitas_tangki']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Kapasitas Penumpang(Orang)</label>
                                        <input class="form-control" type="text" name="kapasitas_penumpang" value="<?php echo $var['kapasitas_penumpang']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Radius Putar/Momen Puntir(m)</label>
                                        <input class="form-control" type="text" name="radius" value="<?php echo $var['radius']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Panjang Kendaraan(mm)</label>
                                        <input class="form-control" type="text" name="panjang" value="<?php echo $var['panjang']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Tinggi Kendaraan(mm)</label>
                                        <input class="form-control" type="text" name="tinggi" value="<?php echo $var['tinggi']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Lebar Kendaraan(mm)</label>
                                        <input class="form-control" type="text" name="lebar" value="<?php echo $var['lebar']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Sumbu Roda/Jarak Poros Roda(mm)</label>
                                        <input class="form-control" type="text" name="sumbu_roda" value="<?php echo $var['sumbu_roda']; ?>" autocomplete="Off">
                                    </div>
                                    <input type="submit" class="btn btn-success" value="Update">
                                    <a href="dimensi.php" class="btn btn-warning">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
