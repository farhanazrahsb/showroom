                ...
                <ul class="nav" id="main-menu">
                    ...
                    <a href="#" class="active-menu"><i class="fa fa-car fa-fw"></i> Showroom<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                            <a href="mesin.php" class="active-menu"><i class="fa fa-plus fa-fw"></i> Mesin</a>
                            </li>
                            <li>
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        include "../koneksi/koneksi.php";
                        $no = $_GET['no'];
                        $query = mysqli_query($koneksi, "SELECT * FROM mesin WHERE no = '$no'");
                        while($var=mysqli_fetch_array($query)){
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <form action="mesin_edit_query.php" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                    <label>Diameter x Langkah(mm)</label>
                                    <input type="text" name="diameter" class="form-control" value="<?php echo $var['diameter']; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label>Perbandingan Kompresi</label>
                                    <input type="text" name="kompresi" class="form-control" value="<?php echo $var['kompresi']; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label>Jumlah/Tipe Silinder</label>
                                    <input type="text" name="jumlah_silinder" class="form-control" value="<?php echo $var['jumlah_silinder']; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label>Kapasitas Silinder(CC)</label>
                                    <input type="text" name="kapasitas_silinder" class="form-control" value="<?php echo $var['kapasitas_silinder']; ?>">
                                    </div>
                                    </div>
                                    <div class="col-lg-6">
                                    <div class="form-group">
                                    <label>Sistem Bahan Bakar</label>
                                    <input type="text" name="sistem_bbm" class="form-control" value="<?php echo $var['sistem_bbm']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="text" name="daya_maks" class="form-control" value="<?php echo $var['daya_maks']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Torsi Maksimum</label>
                                    <input type="text" name="torsi_maks" class="form-control" value="<?php echo $var['torsi_maks']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Tipe Mesin</label>
                                    <input type="text" name="tipe_mesin" class="form-control" value="<?php echo $var['tipe_mesin']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Sistem Penggerak Roda</label>
                                    <input type="text" name="penggerak_roda" class="form-control" value="<?php echo $var['penggerak_roda']; ?>" autocomplete="Off">
                                    </div>
                                    <input type="submit" class="btn btn-success" value="Update">
                                    <a href="mesin.php" class="btn btn-warning">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
