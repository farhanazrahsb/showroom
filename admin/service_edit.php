        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                    <a href="service.php" class="active-menu"><i class="fa fa-wrench fa-fw"></i> Service</a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        include "../koneksi/koneksi.php";
                        $no = $_GET['no'];
                        $query = mysqli_query($koneksi, "SELECT * FROM service WHERE no = '$no'");
                        while($var=mysqli_fetch_array($query)){
                        ?>
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <form action="service_edit_query.php" enctype="multipart/form-data" method="post">
                                    <input type="hidden" name="no" class="form-control" value="<?php echo $var['no']; ?>">
                                    <div class="form-group">
                                    <label>Nama Perusahaan Service</label>
                                    ...
                                    <div class="form-group">
                                    <span><center><img src="images/service/<?php echo $var['gambar']; ?>" width="100" height="100"></center></span>
                                    <span><center><?php echo $var['gambar']; ?></center></span>
                                    </div>
                                    </div>
                                    <input type="submit" class="btn btn-success" value="Update">
                                    <a href="service.php" class="btn btn-warning">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
