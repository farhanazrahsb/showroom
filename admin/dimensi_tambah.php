                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form action="dimensi_tambah_input.php" method="post" enctype="multipart/form-data" role="form">
                                    ...
                                    <label>Berat Kosong Tanpa Muatan(Kg)</label>
                                        <input class="form-control" type="text" name="berat_tanpa_muatan" placeholder="Berat Kosong Tanpa Muatan(Kg)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Berat Kosong Dengan Muatan(Kg)</label>
                                        <input class="form-control" type="text" name="berat_muatan" placeholder="Berat Kosong Dengan Muatan(Kg)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Jarak Pijak Depan(mm)</label>
                                        <input class="form-control" type="text" name="jarak_depan" placeholder="Jarak Pijak Depan(mm)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Jarak Rendah Kendaraan(mm)</label>
                                        <input class="form-control" type="text" name="jarak_rendah" placeholder="Jarak Rendah Kendaraan(mm)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Jarak Pijak Belakang(mm)</label>
                                        <input class="form-control" type="text" name="jarak_belakang" placeholder="Jarak Pijak Belakang(mm)" autocomplete="Off">
                                    </div>
                                    </div>
                                    <div class="col-lg-6">
                                    <div class="form-group">
                                    <label>Kapasitas Tangki(L)</label>
                                        <input class="form-control" type="text" name="kapasitas_tangki" placeholder="Kapasitas Tangki(L)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Kapasitas Penumpang(Orang)</label>
                                        <input class="form-control" type="text" name="kapasitas_penumpang" placeholder="Kapasitas Penumpang(Orang)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Radius Putar/Momen Puntir(m)</label>
                                        <input class="form-control" type="text" name="radius" placeholder="Radius Putar/Momen Puntir(m)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Panjang Kendaraan(mm)</label>
                                        <input class="form-control" type="text" name="panjang" placeholder="Panjang Kendaraan(mm)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Tinggi Kendaraan(mm)</label>
                                        <input class="form-control" type="text" name="tinggi" placeholder="Tinggi Kendaraan(mm)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Lebar Kendaraan(mm)</label>
                                        <input class="form-control" type="text" name="lebar" placeholder="Lebar Kendaraan(mm)" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Sumbu Roda/Jarak Poros Roda(mm)</label>
                                        <input class="form-control" type="text" name="sumbu_roda" placeholder="Sumbu Roda/Jarak Poros Roda(mm)" autocomplete="Off">
                                    </div>
