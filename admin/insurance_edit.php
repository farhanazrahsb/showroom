        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                    <a href="insurance.php" class="active-menu"><i class="fa fa-users fa-fw"></i> Partner Insurance</a>
                    </li>
                </ul>
            </div>
        </nav>  
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        include "../koneksi/koneksi.php";
                        $no = $_GET['no'];
                        $query = mysqli_query($koneksi, "SELECT * FROM insurance WHERE no = '$no'");
                        while($var=mysqli_fetch_array($query)){
                        ?>
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <form action="insurance_edit_query.php" enctype="multipart/form-data" method="post">
                                    ...
                                    <input type="text" name="nama_market" class="form-control" value="<?php echo $var['nama_market']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Nomor Handphone</label>
                                    <input type="text" name="no_hp" class="form-control" value="<?php echo $var['no_hp']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Alamat</label>
                                    <textarea name="alamat" class="form-control" value="<?php echo $var['alamat']; ?>"><?php echo $var['alamat']; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                    <label>Kota</label>
                                    <input type="text" name="kota" class="form-control" value="<?php echo $var['kota']; ?>" autocomplete="Off">
                                    </div>
                                    <div class="form-group">
                                    <label>Map</label>
                                    <textarea name="map" class="form-control" value="<?php echo $var['map']; ?>"><?php echo $var['map']; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                    <label>Gambar</label>
                                    ...
                                    <div class="form-group">
                                    <span><center><img src="images/insurance/<?php echo $var['gambar']; ?>" width="100" height="100"></center></span>
                                    <span><center><?php echo $var['gambar']; ?></center></span>
                                    </div>
                                    </div>
                                    <input type="submit" class="btn btn-success" value="Update">
                                    <a href="insurance.php" class="btn btn-warning">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
