            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        include "../koneksi/koneksi.php";
                        $no = $_GET['no'];
                        $query = mysqli_query($koneksi, "SELECT * FROM gallery WHERE no = '$no'");
                        while($var=mysqli_fetch_array($query)){
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <form action="car_gallery_edit_query.php" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                    <span><center><img src="images/showroom_detail/<?php echo $var['gambar']; ?>" width="100" height="100"></center></span>
                                    <span><center><?php echo $var['gambar']; ?></center></span>
                                    </div>
                                    </div>
                                    <input type="submit" class="btn btn-success" value="Update">
                                    <a href="car_gallery.php" class="btn btn-warning">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
